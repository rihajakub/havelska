...
test("načte provozní termíny z Airbnb iCal bez údajů hosta", () => {
  ...
  assert.deepEqual(stays, [{ id: "airbnb:stay-1", checkIn: "2026-10-01", checkOut: "2026-10-04", guests: 4, preparationGuests: 4, status: "planned", note: "Výchozí příprava pro 4 – ověřit v Airbnb", source: "airbnb" }]);
});
